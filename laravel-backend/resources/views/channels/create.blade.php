...
@section('page_title', 'Create Channel')
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="url" class="form-control @error('hls_manifest_url') is-invalid @enderror" 
                       id="hls_manifest_url" name="hls_manifest_url" value="{{ old('hls_manifest_url') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control @error('ad_break_strategy') is-invalid @enderror" 
                    ...
                    <option value="static" {{ old('ad_break_strategy', 'static') === 'static' ? 'selected' : '' }}>Static (Based on Interval)</option>
                    <option value="scte35" {{ old('ad_break_strategy') === 'scte35' ? 'selected' : '' }}>SCTE-35 (From Manifest Tags)</option>
                    <option value="hybrid" {{ old('ad_break_strategy') === 'hybrid' ? 'selected' : '' }}>Hybrid (SCTE-35 + Static Fallback)</option>
                </select>
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control @error('ad_break_interval_seconds') is-invalid @enderror" 
                       ...
                       value="{{ old('ad_break_interval_seconds', 360) }}" min="60" step="60"
                       placeholder="360 = 6 minutes">
                <small class="form-text text-muted">How often ad breaks appear (in seconds). Default: 360 (6 minutes). Set to 0 to disable automatic mid-roll ads.</small>
            ...
            <div class="form-group">
                <div class="form-check">
                    <input type="checkbox" class="form-check-input @error('enable_pre_roll') is-invalid @enderror" 
                           ...
                           {{ old('enable_pre_roll', false) ? 'checked' : '' }}>
