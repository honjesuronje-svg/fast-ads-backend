        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <select class="form-control @error('ad_source') is-invalid @enderror" 
                    ...
                    <option value="vast_url" {{ old('ad_source', 'vast_url') === 'vast_url' ? 'selected' : '' }}>VAST URL (External Ad Server)</option>
            ...
            <div class="form-group" id="vast_url_group">
                ...
                <input type="url" class="form-control @error('vast_url') is-invalid @enderror" 
                       id="vast_url" name="vast_url" value="{{ old('vast_url') }}" 
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control @error('duration_seconds') is-invalid @enderror" 
                       id="duration_seconds" name="duration_seconds" value="{{ old('duration_seconds') }}" min="1" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control @error('ad_type') is-invalid @enderror" 
                    ...
                    <option value="linear" {{ old('ad_type') === 'linear' ? 'selected' : '' }}>Linear</option>
                    <option value="non-linear" {{ old('ad_type') === 'non-linear' ? 'selected' : '' }}>Non-Linear</option>
                    <option value="companion" {{ old('ad_type') === 'companion' ? 'selected' : '' }}>Companion</option>
                </select>
                @error('ad_type')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
            ...
            <div class="form-group">
                ...
                <input type="url" class="form-control @error('click_through_url') is-invalid @enderror" 
                       id="click_through_url" name="click_through_url" value="{{ old('click_through_url') }}">
