<?php $__env->startSection('page_title', 'Edit Ad'); ?>
...
<div class="card">
    ...
    <form action="<?php echo e(route('ads.update', $ad)); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                    ...
                    <?php $__currentLoopData = $tenants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tenant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($tenant->id); ?>" <?php echo e(old('tenant_id', $ad->tenant_id) == $tenant->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                    ...
                    <?php $__currentLoopData = $campaigns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $campaign): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($campaign->id); ?>" <?php echo e(old('campaign_id', $ad->campaign_id) == $campaign->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                       id="name" name="name" value="<?php echo e(old('name', $ad->name)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                    ...
                    <option value="vast_url" <?php echo e(old('ad_source', $ad->ad_source) === 'vast_url' ? 'selected' : ''); ?>>VAST URL (External Ad Server)</option>
...
unset($__errorArgs, $__bag); ?>" 
                       id="vast_url" name="vast_url" value="<?php echo e(old('vast_url', $ad->vast_url)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                       id="duration_seconds" name="duration_seconds" value="<?php echo e(old('duration_seconds', $ad->duration_seconds)); ?>" min="1" required>
...
unset($__errorArgs, $__bag); ?>" 
                    ...
                    <option value="linear" <?php echo e(old('ad_type', $ad->ad_type) === 'linear' ? 'selected' : ''); ?>>Linear</option>
                    <option value="non-linear" <?php echo e(old('ad_type', $ad->ad_type) === 'non-linear' ? 'selected' : ''); ?>>Non-Linear</option>
                    <option value="companion" <?php echo e(old('ad_type', $ad->ad_type) === 'companion' ? 'selected' : ''); ?>>Companion</option>
                </select>
...
unset($__errorArgs, $__bag); ?>" 
                       id="click_through_url" name="click_through_url" value="<?php echo e(old('click_through_url', $ad->click_through_url)); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                    ...
                    <option value="active" <?php echo e(old('status', $ad->status) === 'active' ? 'selected' : ''); ?>>Active</option>
                    <option value="inactive" <?php echo e(old('status', $ad->status) === 'inactive' ? 'selected' : ''); ?>>Inactive</option>
                </select>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lamkapro/fast-ads-backend/laravel-backend/resources/views/ads/edit.blade.php ENDPATH**/ ?>